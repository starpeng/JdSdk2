...
{
﻿    public class EtmsEpartnerOrderBackstationRequest : JdRequestBase<EtmsEpartnerOrderBackstationResponse>
    {
        ...
        {
            get{ return "jingdong.etms.epartner.order.backstation"; }
        }
