...
{
﻿    public class ImPopWaiterOnlinetimeStatGetRequest : JdRequestBase<ImPopWaiterOnlinetimeStatGetResponse>
    {
        ...
        {
            get{ return "jingdong.im.pop.waiter.onlinetime.stat.get"; }
        }
