...
{
﻿    public class WareStrollLadychannelListGetRequest : JdRequestBase<WareStrollLadychannelListGetResponse>
    {
        ...
        {
            get{ return "jingdong.ware.stroll.ladychannel.list.get"; }
        }
