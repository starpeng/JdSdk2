...
{
﻿    public class WarePromotionActivitywareListGetRequest : JdRequestBase<WarePromotionActivitywareListGetResponse>
    {
        ...
        {
            get{ return "jingdong.ware.promotion.activityware.list.get"; }
        }
