...
{
﻿    public class EccMallMallbannercenterUpdateRequest : JdRequestBase<EccMallMallbannercenterUpdateResponse>
    {
        ...
        {
            get{ return "jingdong.ecc.mall.mallbannercenter.update"; }
        }
