...
{
﻿    public class EccMallMallbannercenterDeleteRequest : JdRequestBase<EccMallMallbannercenterDeleteResponse>
    {
        ...
        {
            get{ return "jingdong.ecc.mall.mallbannercenter.delete"; }
        }
